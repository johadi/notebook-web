    ...
    return (
      <div className="tab-pane fade"
        ...
        <form>
          ...
          <Input autoComplete="off" size="sm" name="password" label="Your password" icon="lock" type="password"/>
          <Input autoComplete="off" size="sm" name="password_confirmation" label="Confirm your password" icon="lock" type="password"/>
